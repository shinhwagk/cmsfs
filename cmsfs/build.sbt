...
lazy val `collect-ssh-impl` = (project in file("collect-ssh/impl"))
  ...
  .settings(implCommonSettings: _*)
  .settings(lagomForkedTestSettings: _*)
  .dependsOn(`collect-ssh-api`, `collect-core`, `common`, `monitor-api`, `lagom-service-locator`)
...
lazy val `collect-jdbc-impl` = (project in file("collect-jdbc/impl"))
  ...
  .settings(implCommonSettings: _*)
  .settings(lagomForkedTestSettings: _*)
  .dependsOn(`collect-jdbc-api`, `collect-core`, `common`, `monitor-api`, `lagom-service-locator`)
...
lazy val `format-analyze-impl` = (project in file("format-analyze/impl"))
  ...
  .settings(implCommonSettings: _*)
  .settings(lagomForkedTestSettings: _*)
  .dependsOn(`format-analyze-api`, `format-core`, `common`, `monitor-api`, `elasticsearch-api`, `lagom-service-locator`)
...
lazy val `format-alarm-impl` = (project in file("format-alarm/impl"))
  ...
  .settings(implCommonSettings: _*)
  .settings(lagomForkedTestSettings: _*)
  .dependsOn(`format-alarm-api`, `format-core`, `common`, `monitor-api`, `notification-api`, `lagom-service-locator`)
